    ...
    if (city && country && units1==="metric" && type==="weather") {
      ...
      // use the second data for forecat informations
       ...
       this.setState({
        ...
        wind_speed1:data2.data[0].wind_spd.toPrecision(2)*3.6 + " m/s",
        wind_speed2:data2.data[1].wind_spd.toPrecision(2)*3.6 + " m/s",
        wind_speed3:data2.data[2].wind_spd.toPrecision(2)*3.6 + " m/s",
        wind_speed4:data2.data[3].wind_spd.toPrecision(2)*3.6 + " m/s",
        wind_speed5:data2.data[4].wind_spd.toPrecision(2)*3.6 + " m/s",
        wind_speed6:data2.data[5].wind_spd.toPrecision(2)*3.6 + " m/s",
        wind_speed7:data2.data[6].wind_spd.toPrecision(2)*3.6 + " m/s",
