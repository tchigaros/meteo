  ...
  <tr className="description_weather__info">
   ...
   <tr className="description_weather__info">
 	
	    {
	     ...
	     {
	     props.description2 && <th className="weather__key" >{ props.description2 } <img src={"https://openweathermap.org/img/w/" + props.iconcode2 + ".png"} className="icondescription"></img></th>
	    }
