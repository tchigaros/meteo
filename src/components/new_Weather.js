...
<table>
  ...
  <tr className="description_weather__info">
 	
	    {
	     ...
	     {
	     props.description && <th className="weather__key" >{ props.description} <img src={"http://openweathermap.org/img/w/" + props.iconcode + ".png"} className="icondescription"></img></th>
	    }
